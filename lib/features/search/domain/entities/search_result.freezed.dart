...
abstract class $SearchResultCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Track> tracks, List<Album> albums, List<Artist> artists});
}
...
abstract class $AlbumCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, List<Artist> artists, List<Image> images});
}
...
class _$AlbumImpl implements _Album {
  ...
  @override
  String toString() {
    return 'Album(id: $id, name: $name, artists: $artists, images: $images)';
  }
...
abstract class _Album implements Album {
  const factory _Album(
      ...
      required final String name,
      required final List<Artist> artists,
      required final List<Image> images}) = _$AlbumImpl;
...
class _$ArtistImpl implements _Artist {
  const _$ArtistImpl(
      {required this.id, required this.name, required final List<Image> images})
      : _images = images;
...
abstract class _Artist implements Artist {
  const factory _Artist(
      {required final String id,
      required final String name,
      required final List<Image> images}) = _$ArtistImpl;
